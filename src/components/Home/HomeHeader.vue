...
// 用户头像
const userAvatar = ref("https://kiripet.tos-cn-beijing.volces.com/image/a1.png");
...
const loadUserAvatar = () => {
  ...
  if (savedUserData) {
    try {
      ...
      if (parsedData.userProfile && parsedData.userProfile.avatar) {
        userAvatar.value = parsedData.userProfile.avatar;
      }
    } catch (error) {
      console.error("Failed to parse user data for avatar:", error);
    }
  }
};
      ...
      <div class="home-header-right">
        ...
        <div class="header-nav" :class="{ 'menu-open': isMenuOpen }">
          <ul>
            ...
            <template v-if="show">
              <li>
                <span @click="router.push('/user/11111111')"
                  ><img
                    :src="userAvatar"
                    class="user-avatar"
                /></span>
